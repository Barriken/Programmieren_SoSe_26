...
public class BugInfoTest {
	...
	private Constructor<?> getConstructor() throws NoSuchMethodException, SecurityException, ClassNotFoundException {
		Class<?> bugInfoClass = Class.forName("de.tha.prog2.task3.annotations.BugInfo");
		Class<?> bugAnnotation = Class.forName("de.tha.prog2.task3.annotations.Bug");
		Class<?> typeEnum = bugAnnotation.getClasses()[0];
		return bugInfoClass.getConstructor(Class.class, Class.class, Member.class, typeEnum, String.class);
	...
	public void testToString() throws NoSuchMethodException, SecurityException, ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		Object o = ct.newInstance(
				...
				"This is a bug");
		assertEquals("null\tde.tha.prog2.task3.BugInfoTest$1\tnull\tINVALID\tThis is a bug", o.toString());
		...
		o = ct.newInstance(
				...
				typeEnum.getEnumConstants()[0],
				"This is a bug");
		assertEquals("de.tha.prog2.task3.BugInfoTest\tde.tha.prog2.task3.BugInfoTest$1\tpublic void de.tha.prog2.task3.BugInfoTest$1.method()\tINVALID\tThis is a bug", o.toString());
	}
}

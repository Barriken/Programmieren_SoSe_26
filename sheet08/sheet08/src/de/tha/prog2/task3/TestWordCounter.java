...
public class TestWordCounter {
    ...
    private Object createWord(String word, String position) throws Exception {
		Class <?> wordClass = Class.forName("de.tha.prog2.task3.Word");
		Class <?> enumClass = Class.forName("de.tha.prog2.task3.Word$Position");
	...
	public void testWordCounter() throws Throwable {
		Class<?> wordCounterClass = Class.forName("de.tha.prog2.task3.WordCounter");

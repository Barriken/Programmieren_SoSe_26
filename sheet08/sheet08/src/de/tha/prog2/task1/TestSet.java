...
public class TestSet {
	...
	protected void testMethod(Class<?> clazz, String methodName, Class<?> returnType, Class<?>...parameters) throws Exception {
	...
	public void testClasses() throws Exception {
		Class<?> setClass = Class.forName("de.tha.prog2.task1.Set");
		...
		Class<?> abstractSetClass = Class.forName("de.tha.prog2.task1.AbstractSet");
		assertTrue(Modifier.isAbstract(abstractSetClass.getModifiers()));
		Class<?> normalSetClass = Class.forName("de.tha.prog2.task1.NormalSet");
		Object normalSet = normalSetClass.getConstructor().newInstance();
		Class<?> orderedSetClass = Class.forName("de.tha.prog2.task1.OrderedSet");
	...
	private ClassInfo testSetBasics(String className) throws Exception {
	...
	public void testNormalSet() throws Exception {
		ClassInfo classInfo = testSetBasics("de.tha.prog2.task1.NormalSet");
	...
	public void testOrderedSet() throws Exception {
		ClassInfo classInfo = testSetBasics("de.tha.prog2.task1.OrderedSet");

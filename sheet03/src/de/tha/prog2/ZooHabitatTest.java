...
import de.tha.prog2.animals.*;
import de.tha.prog2.exceptions.*;
...
public class ZooHabitatTest {
    ...
    @BeforeEach
    void checkMyZooTestExists() {
        boolean exists = classExists("de.tha.prog2.MyZooTest");
        assumeTrue(exists,
                "Die Tests werden erst ausgeführt, wenn eine Klasse MyZooTest existiert.");
    }
    ...
    @Test
    void testZooHabitatSameAnimal() throws HabitatFullException {
